...
class Product(models.Model):
    ...
    old_price = models.PositiveIntegerField(
        blank=True,
        null=True,
        help_text="Original price in DA, for promotions"
    )
...
class Wilaya(models.Model):
    ...
    delivery_fee = models.PositiveIntegerField(
        default=0,
        help_text="Home delivery fee in DA"
    )

    stopdesk_fee = models.PositiveIntegerField(
        blank=True,
        null=True,
        help_text="Stopdesk delivery fee in DA (optional)"
    )
...
class OrderItem(models.Model):
    ...
    price = models.PositiveIntegerField(
        help_text="Unit price in DA at time of order"
    )
